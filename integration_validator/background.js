        ...
        Object.keys(validator.config).forEach(function(a) {
            if(a in im_params) {
                if(!im_params[a].match(validator.config[a].format)) {
                    pushLog({"type": "Incorrect Parameter Format", "name": validator.config[a].impName, "value": im_params[a], "msg": validator.config[a].errorMsg}); 
                   }
            } else {
    ...
    Object.keys(validator.hotels).forEach(function(a) {
        if(a in im_params) {
            if(!im_params[a].match(validator.hotels[a].format)) {
                pushLog({"type": "Incorrect Parameter Format", "name": validator.hotels[a].impName, "value": im_params[a], "msg": validator.hotels[a].errorMsg}); 
               }
        } else {
    ...
    Object.keys(validator.flights).forEach(function(a) {
        if(a in im_params) {
            if(!im_params[a].match(validator.flights[a].format)) {
                pushLog({"type": "Incorrect Parameter Format", "name": validator.flights[a].impName, "value": im_params[a], "msg": validator.flights[a].errorMsg}); 
               }
        } else {
    ...
    Object.keys(validator.cars).forEach(function(a) {
        if(a in im_params) {
            if(!im_params[a].match(validator.cars[a].format)) {
                pushLog({"type": "Incorrect Parameter Format", "name": validator.cars[a].impName, "value": im_params[a], "msg": validator.cars[a].errorMsg}); 
               }
        } else {
